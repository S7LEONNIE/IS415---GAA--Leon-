...
Results: The observed G(r) is above the G(theo) and above the envelope. This shows that the functional water points are clustered, hence rejecting the null hypothesis that the functional water points in Osun State, Nigeria are randomly distributed.
...
Results: The observed G(r) is above the G(theo) and above the envelope. This shows that the non-functional water points are clustered, hence rejecting the null hypothesis that the functional water points in Osun State, Nigeria are randomly distributed.
...
Results: The observed L(r) is above the L(theo) and above the envelope. This shows that the functional water points are clustered, hence rejecting the null hypothesis that the functional water points in Osun State, Nigeria are randomly distributed.
...
Results: The observed L(r) is above the L(theo) and above the envelope. This shows that the functional water points are clustered, hence rejecting the null hypothesis that the non-functional water points in Osun State, Nigeria are randomly distributed.
...
Results: When the Colocation Analysis tool is run, it adds two fields to the resulting Output Features. As observed in the above figure, the Local Colocation Quotient is 1.007 which is greater than 1. Hence, features of the Category of Interest (Functional Water Point) are more likely to have features of the Neighbouring Category (Non-Functional Water Point) within their neighbourhood.
